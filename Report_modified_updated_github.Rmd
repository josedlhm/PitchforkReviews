...
knitr::include_graphics("frequency_plot.png")
```
...
knitr::include_graphics("terrible_words_1.png")
```
...
knitr::include_graphics("terrible_artist_plot.png")
```
...
knitr::include_graphics("table_terrible.html")
```
...
knitr::include_graphics("ridge_plot_1.png")
```
...
```{r echo=FALSE, fig.cap="Figure 5", out.width = '100%'}
knitr::include_graphics("terrible_words_recalculated.png")
```
